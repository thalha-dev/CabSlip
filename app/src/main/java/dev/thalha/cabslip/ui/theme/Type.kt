...
// Professional Typography using system fonts for optimal compatibility
val DisplayFontFamily = FontFamily.SansSerif // Premium display font
val BodyFontFamily = FontFamily.SansSerif    // Clean body text font
...
object CabSlipTypography {
    // Receipt specific typography
    val receiptTitle = TextStyle(
        fontFamily = DisplayFontFamily,
        fontWeight = FontWeight.Bold,
        fontSize = 24.sp,
        lineHeight = 32.sp,
